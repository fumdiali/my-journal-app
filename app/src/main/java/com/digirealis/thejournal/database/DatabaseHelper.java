package com.digirealis.thejournal.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Drop older table conditionally
    ...
    public long insertEntry(String entry) {
        ...
        values.put(Entry.COLUMN_ENTRY, entry);
    ...
    public Entry getEntry(long id) {
        ...
        Cursor cursor = db.query(Entry.TABLE_NAME,
                new String[]{Entry.COLUMN_ID, Entry.COLUMN_ENTRY, Entry.COLUMN_TIMESTAMP},
                Entry.COLUMN_ID + "=?",
        ...
        Entry entry = new Entry(
                ...
                cursor.getString(cursor.getColumnIndex(Entry.COLUMN_ENTRY)),
    ...
    public List<Entry> getAllEntries() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                entry.setEntry(cursor.getString(cursor.getColumnIndex(Entry.COLUMN_ENTRY)));
    ...
    public int updateEntry(Entry entry) {
        ...
        ContentValues values = new ContentValues();
        values.put(Entry.COLUMN_ENTRY, entry.getEntry());
